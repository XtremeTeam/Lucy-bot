...
register_command_handler(admin_getglobadmin, COMM_PREFIX+'glob_access', ['superadmin','admin','all', 'new'], 100, 'Display all global access', 'glob_access', ['glob_access'])
register_command_handler(admin_getlocaladminthisconf, COMM_PREFIX+'local_access', ['admin','all', 'new'], 20, 'Extended command "washere".\nDisplay local access this conference', 'local_access', ['local_access'])
register_command_handler(admin_getlocaladminallconf, COMM_PREFIX+'local_access_all', ['superadmin','admin','all', 'new'], 100, 'Show local access to all conferences. WARNING! Huge list could be listed', 'local_access_all', ['local_access_all'])
