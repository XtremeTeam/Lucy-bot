...
#register_command_handler(handler_ban, 'ban', ['admin','all','*','muc'], 20, 'Ð—Ð°Ð±Ð°Ð½Ð¸Ñ‚ÑŒ Ð´ÐµÐ±Ð¾ÑˆÐ¸Ñ€Ð° Ð¿Ð¾ nick Ð¸Ð»Ð¸ jid!', 'ban <nick|jid[|reason]>', ['ban guy', 'ban guy|ÐŸÑˆÐµÐ» Ð¾Ñ‚ÑÐµÐ´Ð¾Ð²Ð°!', 'ban guy@jabber.aq', 'ban guy@jabber.aq|Ð¡Ð²Ð¾Ð±Ð¾Ð´ÐµÐ½!'])
#register_command_handler(handler_visitor, 'visitor', ['admin','all','*','muc'], 16, 'Ð—Ð°Ð±Ñ€Ð°Ñ‚ÑŒ Ñƒ Ð´ÐµÐ±Ð¾ÑˆÐ¸Ñ€Ð° Ð¿Ñ€Ð°Ð²Ð¾ Ð³Ð¾Ð²Ð¾Ñ€Ð¸Ñ‚ÑŒ!', 'visitor <nick>', ['visitor guy'])
#register_command_handler(handler_participant, 'participant', ['admin','all','*','muc'], 16, 'Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÑ‚ Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÐ¼Ð¾Ðµ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ¾Ð¼ Ð² Ð¿ÐµÑ€Ð²Ð¾Ð½Ð°Ñ‡Ð°Ð»ÑŒÐ½Ð¾ ÑÐ¾ÑÑ‚Ð¾ÑÐ½Ð¸Ðµ, Ñ‚.Ðµ. participant!', 'participant <nick>', ['participant guy'])
#register_command_handler(handler_unban, 'unban', ['admin','all','*','muc'], 20, 'Ð”Ð¾ÑÑ‚Ð°Ñ‚ÑŒ Ð·Ð°ÑÑ€Ð°Ð½Ñ†Ð° Ð¸Ð· Ð±Ð°Ð½Ð¸!', 'unban <jid>', ['unban guy@jabber.aq!'])
#register_command_handler(handler_none, 'none', ['admin','all','*','muc'], 20, 'ÐŸÐ¾Ð½Ð¸Ð·Ð¸Ñ‚ÑŒ Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ° Ð´Ð¾ ÑÐ°Ð¼Ð¾Ð³Ð¾ Ð½Ð¸Ð·ÐºÐ¾Ð³Ð¾, Ñ‚.Ðµ. none!', 'none <nick>', ['none guy'])
#register_command_handler(handler_member, 'member', ['admin','all','*','muc'], 20, 'ÐŸÐ¾Ð²Ñ‹ÑÐ¸Ñ‚ÑŒ Ñ€Ð°Ð½Ð³ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ° Ñ none Ð´Ð¾ Ñ€Ð°Ð½Ð³Ð° member, Ñ‚.Ðµ. ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ Ð¿Ð¾ÑÑ‚Ð¾ÑÐ½Ð½Ñ‹Ð¼ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ¾Ð¼!', 'member <nick[|reason]>', ['member guy', 'member guy|Ð Ð°Ð´ÑƒÐ¹ÑÑ, Ñ‚ÐµÐ¿ÐµÑ€ÑŒ Ñ‚Ñ‹ Ð¼ÐµÐ¼Ð±ÐµÑ€!'])
#register_command_handler(handler_moderator, 'moderator', ['admin','all','*','muc'], 20, 'ÐŸÐ¾Ð²Ñ‹ÑÐ¸Ñ‚ÑŒ Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÐ¼Ð¾Ðµ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ¾Ð¼ Ñ participant Ð´Ð¾ Ð¿Ð¾Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ moderator, Ñ‚.Ðµ. ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð½Ñ‹Ð¼ Ð¼Ð¾Ð´ÐµÑ€Ð°Ñ‚Ð¾Ñ€Ð¾Ð¼, Ð´Ð¾ Ð²Ñ‹Ñ…Ð¾Ð´Ð° Ð¸Ð· ÐºÐ¾Ð½Ñ„ÐµÑ€ÐµÐ½Ñ†Ð¸Ð¸!', 'moderator <nick>', ['moderator guy'])
#register_command_handler(handler_admin, 'admin', ['superadmin','all','*','muc'], 30, 'ÐŸÐ¾Ð²Ñ‹ÑÐ¸Ñ‚ÑŒ Ñ€Ð°Ð½Ð³ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ° Ñ none Ð¸Ð»Ð¸ member Ð´Ð¾ Ñ€Ð°Ð½Ð³Ð° admin, Ñ‚.Ðµ. ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ Ð°Ð´Ð¼Ð¸Ð½Ð¾Ð¼ ÐºÐ¾Ð½Ñ„ÐµÑ€ÐµÐ½Ñ†Ð¸Ð¸ Ð¸ Ð¿Ð¾ÑÑ‚Ð¾ÑÐ½Ð½Ñ‹Ð¼ Ð¼Ð¾Ð´ÐµÑ€Ð°Ñ‚Ð¾Ñ€Ð¾Ð¼!', 'admin <nick [|reason]>', ['admin guy', 'admin guy|Ð Ð°Ð´ÑƒÐ¹ÑÑ, Ñ‚ÐµÐ¿ÐµÑ€ÑŒ Ñ‚Ñ‹ Ð°Ð´Ð¼Ð¸Ð½!'])
#register_command_handler(handler_owner, 'owner', ['superadmin','all','*','muc'], 30, 'ÐŸÐ¾Ð²Ñ‹ÑÐ¸Ñ‚ÑŒ Ñ€Ð°Ð½Ð³ ÑƒÑ‡Ð°ÑÑ‚Ð½Ð¸ÐºÐ° Ð´Ð¾ Ð²Ñ‹ÑÑˆÐµÐ³Ð¾ - owner, Ñ‚.Ðµ. ÑÐ´ÐµÐ»Ð°Ñ‚ÑŒ Ñ…Ð¾Ð·ÑÐ¸Ð½Ð¾Ð¼ ÐºÐ¾Ð½Ñ„ÐµÑ€ÐµÐ½Ñ†Ð¸Ð¸!', 'owner <nick[|reason]>', ['owner guy', 'owner guy|Ð Ð°Ð´ÑƒÐ¹ÑÑ, Ñ‚ÐµÐ¿ÐµÑ€ÑŒ Ñ‚Ñ‹ Ð¾Ð²Ð½ÐµÑ€!'])
#register_command_handler(handler_set_subject, 'set_subject', ['admin','all','*','muc'], 16, 'Ð£ÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°ÐµÑ‚ Ñ‚ÐµÐ¼Ñƒ (Ñ‚Ð¾Ð¿Ð¸Ðº) Ð² ÐºÐ¾Ð½Ñ„ÐµÑ€ÐµÐ½Ñ†Ð¸Ð¸!', 'set_subject <subject>', ['set_subject Ð¢ÐµÐ¼Ð°!'])
