...
register_command_handler(handler_kick, COMM_PREFIX+'kick', ['admin','all','*','muc'], 16, 'Kick a user!', COMM_PREFIX+'kick <nick[|reason]>', [COMM_PREFIX+'kick guy', COMM_PREFIX+'kick guy|Первый пошел!'])
register_command_handler(handler_ban, COMM_PREFIX+'ban', ['admin','all','*','muc'], 20, 'Banned a nick or jid!', COMM_PREFIX+'ban <nick|jid[|reason]>', [COMM_PREFIX+'ban guy', COMM_PREFIX+'ban guy|Пшел отседова!', COMM_PREFIX+'ban guy@jsmart.web.id', COMM_PREFIX+'ban guy@jsmart.web.id|Свободен!'])
register_command_handler(handler_visitor, COMM_PREFIX+'visitor', ['admin','all','*','muc'], 16, 'Refuse a user right to speak!', COMM_PREFIX+'visitor <nick>', [COMM_PREFIX+'visitor guy'])
register_command_handler(handler_participant, COMM_PREFIX+'participant', ['admin','all','*','muc'], 16, 'Returns the position taken by the participant in the original condition, ie participant!!', COMM_PREFIX+'participant <nick>', [COMM_PREFIX+'participant guy'])
register_command_handler(handler_unban, COMM_PREFIX+'unban', ['admin','all','*','muc'], 20, 'Release an asshole JID out from quarantine!', COMM_PREFIX+'unban <jid>', [COMM_PREFIX+'unban guy@jsmart.web.id!'])
register_command_handler(handler_none, COMM_PREFIX+'none', ['admin','all','*','muc'], 20, 'Change a user position to the lowest role!', COMM_PREFIX+'none <nick>', [COMM_PREFIX+'none guy'])
register_command_handler(handler_member, COMM_PREFIX+'member', ['admin','all','*','muc'], 20, 'Change a user position to a permanent member!', COMM_PREFIX+'member <nick[|reason]>', [COMM_PREFIX+'member guy', COMM_PREFIX+'member guy|Congratulation, be a good member!'])
register_command_handler(handler_moderator, COMM_PREFIX+'moderator', ['admin','all','*','muc'], 20, 'Increase the position of participant or member, ie to make the interim moderator!', COMM_PREFIX+'moderator <nick>', [COMM_PREFIX+'moderator guy'])
register_command_handler(handler_admin, COMM_PREFIX+'admin', ['superadmin','all','*','muc'], 30, 'Change a user position to admin of conference and permanent moderator!', COMM_PREFIX+'admin <nick [|reason]>', [COMM_PREFIX+'admin guy', COMM_PREFIX+'admin guy|Congratulation, now you are admin!'])
register_command_handler(handler_owner, COMM_PREFIX+'owner', ['superadmin','all','*','muc'], 30, 'Change a user position to Owner of conference and permanent moderator!', COMM_PREFIX+'owner <nick[|reason]>', [COMM_PREFIX+'owner guy', COMM_PREFIX+'owner guy|Congratulation, now you are owner!'])
register_command_handler(handler_set_subject, COMM_PREFIX+'set_subject', ['admin','all','*','muc'], 16, 'Sets the subject (topic) in the conference!', COMM_PREFIX+'set_subject <subject>', [COMM_PREFIX+'set_subject Welcome!'])
register_command_handler(handler_akick, COMM_PREFIX+'akick', ['admin','all','*','amuc'], 20, 'Adds a rule to the list autokick, can be any word or regular expression. without parameters shows list of rules. When you specify a negative number removes the rule number after the "-" from the list of rules. When you specify "-" without number clears the list of rules.', COMM_PREFIX+'akick <word|regexp> [|reason]', [COMM_PREFIX+r'akick .*@jabber\.ru',COMM_PREFIX+r'akick guy',COMM_PREFIX+r'akick .*@jabber\..* | you are not welcome here!',COMM_PREFIX+r'akick -3',COMM_PREFIX+r'akick -',COMM_PREFIX+r'akick'])
register_command_handler(handler_amoderator, COMM_PREFIX+'amoderator', ['admin','all','*','amuc'], 20, 'Adds a rule to the list automoderator, can be any word or regular expression. Without arguments displays list of rules. When you specify a negative number removes the rule with the number after "-" from the list of rules. When you specify "-" without a number of clears the list of rules.', COMM_PREFIX+'amoderator <word|regexp>', [COMM_PREFIX+r'amoderator .*@jabber\.ru',COMM_PREFIX+r'amoderator guy',COMM_PREFIX+r'amoderator -3',COMM_PREFIX+r'amoderator -',COMM_PREFIX+r'amoderator'])
register_command_handler(handler_avisitor, COMM_PREFIX+'avisitor', ['admin','all','*','amuc'], 20, 'Adds a rule to the list avisitor, can be any word or regular expression. without parameters shows list of rules. When you specify "-" without a number of clears the list of rules. When you specify a negative number removes the rule with the number after "-" from the list of rules.', COMM_PREFIX+'avisitor <word|regexp>', [COMM_PREFIX+r'avisitor .*@jabber\.ru',COMM_PREFIX+r'avisitor guy',COMM_PREFIX+r'avisitor -3',COMM_PREFIX+r'avisitor -',COMM_PREFIX+r'avisitor'])
register_command_handler(handler_aban, COMM_PREFIX+'aban', ['admin','all','*','amuc'], 20, 'Adds a rule to the list of aban, can be any word as well as regular expression. Without arguments displays list of rules. When you specify a negative number removes the rule with the number after "-" from the list of rules. When you specify "-" without a number of clears the list of rules.', COMM_PREFIX+'aban <word|regexp>', [COMM_PREFIX+r'aban .*@jabber\.ru',COMM_PREFIX+r'aban guy',COMM_PREFIX+r'aban guy | you are not welcome here!',COMM_PREFIX+r'aban -3',COMM_PREFIX+r'aban -',COMM_PREFIX+r'aban'])
